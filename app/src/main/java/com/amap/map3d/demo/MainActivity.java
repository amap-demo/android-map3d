...
import com.amap.map3d.demo.map.layers.LayersActivity;
...
import com.amap.map3d.demo.interact.mapcamera.CameraActivity;
import com.amap.map3d.demo.interact.mapcamera.LimitBoundsActivity;
import com.amap.map3d.demo.interact.mapcamera.MapOptionActivity;
import com.amap.map3d.demo.interact.mapcamera.MinMaxZoomLevelActivity;
import com.amap.map3d.demo.interact.mapcamera.ZoomActivity;
...
//			6种实现地图方式
			...
			//绘制默认定位小蓝点
			new DemoDetails(R.string.location_demo, R.string.locationmodesource_description,
