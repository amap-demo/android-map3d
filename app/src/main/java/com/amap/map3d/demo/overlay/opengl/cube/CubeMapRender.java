package com.amap.map3d.demo.overlay.opengl.cube;
...
public class CubeMapRender implements CustomRenderer {
    ...
    private com.amap.map3d.demo.overlay.opengl.cube.Cube cube ;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        //创建cube
        cube = new com.amap.map3d.demo.overlay.opengl.cube.Cube(0.2f,0.2f,0.2f);
        cube.initShader();
    }
